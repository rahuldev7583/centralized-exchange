...
// OB uses Inter across its UI, including tabular-nums for prices/quantities.
...
export const metadata: Metadata = {
  title: "OB — Orderbook Exchange",
  description: "Spot and perpetual futures trading on OB",
};
